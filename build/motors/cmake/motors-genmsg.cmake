...
set(MSG_I_FLAGS "-Imotors:/home/intel/toibot_ws/src/ToiBot1/src/motors/msg")
...
get_filename_component(_filename "/home/intel/toibot_ws/src/ToiBot1/src/motors/msg/motorsCommand.msg" NAME_WE)
add_custom_target(_motors_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "motors" "/home/intel/toibot_ws/src/ToiBot1/src/motors/msg/motorsCommand.msg" ""
)
...
_generate_msg_cpp(motors
  "/home/intel/toibot_ws/src/ToiBot1/src/motors/msg/motorsCommand.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/motors)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/motors\")")
  # install generated code
  install(
